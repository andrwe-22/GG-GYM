...
//    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .authorizeRequests()
                .antMatchers("/","/login.html","/profile.html","/register.html", "/api/members/login", "/api/members/register","/api/members/profile").permitAll() // Ensure these paths are publicly accessible
                .anyRequest().permitAll()
                .and()
